...
leta 1693, glej \ref{bessy}, in jih je moč najti v knjigi \ref{berlekamp}
iz leta 1982. Število normalnih kvadratov reda 5 je izračunal
R. Schroeppel leta 1973 (glej Gardner \ref{gardner}
Natančno število vseh različnih normalnih magičnih kvadratov reda 6 ni znano.
Avtorja navedenega približka sta Pinn in Wieczerkowski (glej \ref{pinn} ki
...
\emph{Games in particular}, in \emph{Winning Ways for Your Mathematical Plays}, vol. 2,
Academic Press, London, 1982.

\bibitem{bessy}
B. F. de Bessy,
\emph{Des quarrez magiques}, De l’imprimerie Royale par Jean Anisson, Paris, 1693.

\bibitem{euler}
L. Euler,
\emph{De quadratis magicis}, Commentationes arithmeticae, 2 (1849), pp. 593–602.

\bibitem{gardner}
M. Gardner,
\emph{Mathematical games}, Scientific American, 234 (1976), pp. 118–122.

\bibitem{pinn}
K. Pinn and C. Wieczerkowski,
\emph{Number of magic squares from parallel tempering Monte Carlo}, Int. J. Mod. Phys. C, 9 (1998), pp. 541–547.
